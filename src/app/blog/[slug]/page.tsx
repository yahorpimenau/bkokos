    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="mb-10 md:mb-14">
          ...
          <h1 className="font-[var(--font-headline)] text-3xl md:text-4xl font-extrabold text-primary leading-tight tracking-tight mb-6">
            {post.title}
          </h1>
        ...
        {/* Bottom share */}
        <div className="mt-12 pt-8 border-t border-primary/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <p className="text-on-surface-variant text-sm">Found this useful? Share it.</p>
          <ShareButtons title={post.title} slug={post.slug} />
        </div>

        {/* CTA */}
        <div className="mt-10 bg-primary text-white rounded-2xl p-8 md:p-10 text-center">
